...
def calculate_distance_to_serve(customer_data, vehicle_capacity_data, depot_data):
...
def main():
    ...
    calculate_distance_to_serve(customer_data_test, vehicle_capacity_data_test, depot_data_test)
